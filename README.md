This Repository is for BirthDayApplication. In the latest version this application  will fetch the data from the database & send mail to the respective person on there birthday date. 
